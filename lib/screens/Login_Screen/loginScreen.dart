...
class LoginScreen extends StatelessWidget {
  ...
  TextEditingController userNameController = TextEditingController()..text="vikntest";
  ...
  loginFunction(   {required String userName,
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Image.asset("assets/login_bg_image/topup_text_image.png",height: mHieght*.06,),
                      SizedBox(
                        height: mHieght * .02,
                      ),
                      const Text(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                    ...
                                    icon: newValue
                                        ? const Icon(Icons.visibility_off,color: Color(0xffC93C13),)
                                        : const Icon(Icons.remove_red_eye,color: Color(0xffC93C13),))),
                          ));
                    }),
                Container(
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            return BlocProvider.of<LoginBloc>(context).add(FetchLogin(
