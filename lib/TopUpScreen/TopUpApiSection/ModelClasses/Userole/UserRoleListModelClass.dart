import 'dart:convert';
/// StatusCode : 6000
/// message : "Successfully listed UserRoles"
...
UserRoleListModelClass userRoleListModelClassFromJson(String str) => UserRoleListModelClass.fromJson(json.decode(str));
String userRoleListModelClassToJson(UserRoleListModelClass data) => json.encode(data.toJson());
class UserRoleListModelClass {
  ...
  UserRoleListModelClass.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
UserRoleListModelClass copyWith({  num? statusCode,
  String? message,
  List<Data>? data,
}) => UserRoleListModelClass(  statusCode: statusCode ?? _statusCode,
