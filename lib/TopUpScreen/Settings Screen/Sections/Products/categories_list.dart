    ...
    return Scaffold(
      resizeToAvoidBottomInset: false,
              ...
              ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        commonBottomSheetClass.settingsBottomSheetFunction(context: context, type: "Category", addOrEdit: 'Edit');
                      },
                      child: Card(
                        elevation: 0,
                        child: Container(
        ...
        floatingActionButton: floatingActionButton(context: context,
            ...
            icon: Icons.add,
            onPressed: () {
              commonBottomSheetClass.settingsBottomSheetFunction(context: context, type: "Category", addOrEdit: 'Add');
