...
class ApiClient {
  ...
  static const String basePathAccounts =
      'https://api.accounts.vikncodes.com/api/v1/';
  ...
  Future<Response> invokeAPI(
    ...
    if (method == 'POST' ||
      ...
      headerParams = {
        ...
        'Cookie':
            'csrftoken=sPO3nP6fHvTWmiExp2OMr7BFRfm8F6M9mTWRKR42ia3TqPF9jmBAsfdU8FocYgWJ; sessionid=pabokcthprx2d28gb6sfzxrpv86qcwul'
      };
    }
    Response response;
    ...
    switch (method) {
      case "POST":
        ...
        break;
      case "LOGIN":
        response = await post(Uri.parse(urlbasepathaccount),
